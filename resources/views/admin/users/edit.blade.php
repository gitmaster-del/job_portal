    ...
    $("#userForm").submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // SIRF EK MESSAGE DIV USE KARO
                var msgDiv = $("#ajaxMessage");
                msgDiv.removeClass('alert-success alert-danger d-none').html('');

                if(response.status){
                    msgDiv.addClass('alert alert-success').html(response.message);
                    ...
                    msgDiv.addClass('alert alert-danger').html('Please fix the errors below.');
